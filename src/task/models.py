...
class TaskList(models.Model):
  ...
  completed_by = models.ForeignKey('users.Profile', null=True, on_delete=models.SET_NULL, related_name='lists')
...
class Task(models.Model):
  created_on = models.DateField(auto_now_add=True)
  completed_on = models.DateField(null=True, blank=True)
  created_by = models.ForeignKey('users.Profile', null=True, on_delete=models.SET_NULL, related_name='created_tasks')
  completed_by = models.ForeignKey('users.Profile', null=True, on_delete=models.SET_NULL, related_name='completed_tasks')
  name = models.CharField(max_length=120)
  description = models.TextField(null=True, blank=True)
  status = models.CharField(
    max_length=2,
